...
from users import views as user_views   # for registration
from django.contrib.auth import views as auth_view  # for authentication

# this import is for media files
...
# this urlpatterns add is also for media files
if settings.DEBUG:
